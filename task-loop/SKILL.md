...
### 每个任务循环开始前
**必须使用 `/clear` 命令清空当前会话的上下文**，以避免 Token 消耗过大和保持处理效率。
...
重要提示：
- **在初始化完成后立即执行一次 /clear**，清空加载技能文件的上下文
- **在每个任务开始前都执行 /clear**，包括：
  - 从 [TODO] 开始新任务前
  - 从 [WIP] 恢复任务前
  - 从 [FIXING] 恢复修复前
  - 从 [DONE]/[FIXED]/[REVIEW] 开始评审前
- **在 task-exec、task-review、task-fix 之间也执行 /clear**
...
2025-02-24 10:00:04 | INFO  | 执行 /clear 清空上下文
2025-02-24 10:00:05 | INFO  | 上下文已清空
...
2025-02-24 10:15:31 | INFO  | 执行 /clear 清空上下文
2025-02-24 10:15:32 | INFO  | 上下文已清空
...
2025-02-24 10:20:18 | INFO  | 执行 /clear 清空上下文
2025-02-24 10:20:19 | INFO  | 上下文已清空
...
─────────────────────────────────────────
操作：执行 /clear 命令
日志：{时间戳} | INFO | 执行 /clear 清空上下文
说明：在开始任何任务前，先清空上下文以减少 Token 消耗
